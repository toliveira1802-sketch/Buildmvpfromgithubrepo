...
export default function StaffGestao() {
  const navigate = useNavigate();

  useEffect(() => {
    // Verificar se o usuário está autenticado como Gestão
    ...
    try {
      ...
      // Verifica se o role é "gestao" (case-insensitive)
      ...
      // Redirecionar para dashboard da gestão
