...
export default function StaffConsultor() {
  const navigate = useNavigate();

  useEffect(() => {
    // Verificar se o usuário está autenticado como Consultor
    ...
    try {
      ...
      // Verifica se o role é "consultor" (case-insensitive)
      if (userData.role?.toLowerCase() !== "consultor") {
