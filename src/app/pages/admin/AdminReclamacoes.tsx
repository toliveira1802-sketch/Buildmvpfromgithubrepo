...
import { AlertTriangle, RefreshCw, Loader2, MessageSquare } from "lucide-react";
    ...
    <AdminLayout>
      <div className="p-6 space-y-6 max-w-4xl mx-auto">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-white flex items-center gap-2">
              <AlertTriangle className="h-8 w-8 text-red-400" />Reclamações
            </h1>
            <p className="text-zinc-400 mt-1">Reclamações e problemas reportados</p>
          </div>
        ...
        <div className="p-4 bg-zinc-800/50 border border-zinc-700 rounded-lg">
          <p className="text-zinc-400 text-sm flex items-center gap-2"><MessageSquare className="h-4 w-4"/>Módulo de Reclamações em desenvolvimento — vinculação com clientes e OS via 04_CLIENTS + 06_OS</p>
        </div>
      </div>
    </AdminLayout>
  );
