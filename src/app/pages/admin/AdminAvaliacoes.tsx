    ...
    <AdminLayout>
      <div className="p-6 space-y-6 max-w-4xl mx-auto">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-white flex items-center gap-2">
              <Star className="h-8 w-8 text-yellow-400" />Avaliações
            </h1>
            <p className="text-zinc-400 mt-1">Notas e avaliações dos clientes</p>
          </div>
        ...
        <div className="p-4 bg-zinc-800/50 border border-zinc-700 rounded-lg">
          <p className="text-zinc-400 text-sm flex items-center gap-2"><MessageSquare className="h-4 w-4"/>Módulo de Avaliações em desenvolvimento — vinculação com clientes e OS via 04_CLIENTS + 06_OS</p>
        </div>
      </div>
    </AdminLayout>
  );
