      ...
      <div className="container mx-auto p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-zinc-400 mt-1">Gestão de contas a receber</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card className="bg-zinc-900 border-zinc-800">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-zinc-400">Recebidas</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card className="bg-zinc-900 border-zinc-800">
          <CardContent className="py-16 text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Nenhuma conta a receber</h3>
            <p className="text-zinc-400 mb-6">Adicione contas para gerenciar recebimentos</p>
            <Button className="bg-blue-600 hover:bg-blue-700">
              <Plus className="h-4 w-4 mr-2" />
