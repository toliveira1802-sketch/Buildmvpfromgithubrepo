...
import { MinusCircle, RefreshCw, Loader2 } from "lucide-react";
      ...
      <div className="p-6 max-w-4xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <div><h1 className="text-3xl font-bold text-white flex items-center gap-2">
            <MinusCircle className="h-8 w-8 text-red-400"/>Despesas</h1>
            <p className="text-zinc-400 mt-1">Custos operacionais — baseado em OS e itens</p>
          </div>
