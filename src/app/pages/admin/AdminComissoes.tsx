  ...
  return (
    <AdminLayout>
      <div className="container mx-auto p-6 space-y-6">
        ...
        <p className="text-zinc-400 -mt-4">Gestão de comissões da equipe</p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="bg-zinc-900 border-zinc-800">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-zinc-400">Total a Pagar</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-zinc-900 border-zinc-800">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-zinc-400">Já Pago</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card className="bg-zinc-900 border-zinc-800">
          <CardContent className="py-16 text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Sem comissões cadastradas</h3>
            <p className="text-zinc-400">Configure regras de comissão para começar</p>
          </CardContent>
        </Card>
      </div>
    </AdminLayout>
