      ...
      <div className="p-6 space-y-6 max-w-4xl mx-auto">
        <div className="flex items-center justify-between">
          <div><h1 className="text-3xl font-bold text-white flex items-center gap-2"><DollarSign className="h-8 w-8 text-green-400"/>Financeiro</h1>
            <p className="text-zinc-400 mt-1">Faturamento e m�tricas do m�s atual</p></div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { label:"Ticket M�dio", value:fmt(data.ticket), icon:TrendingUp, bg:"bg-blue-950 border-blue-800", color:"text-blue-300" },
            { label:"Servi�os Conc.", value:String(data.servicos), icon:DollarSign, bg:"bg-zinc-900 border-zinc-800", color:"text-zinc-400" },
            { label:"Proje��o M�s", value:fmt(projecao), icon:TrendingUp, bg:"bg-purple-950 border-purple-800", color:"text-purple-300" },
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card className="bg-orange-950 border-orange-800"><CardContent className="pt-4">
            ...
            <p className="text-orange-300 text-sm">Em execu��o no p�tio</p>
          </CardContent></Card>
          <Card className="bg-yellow-950 border-yellow-800"><CardContent className="pt-4">
            ...
            <p className="text-yellow-300 text-sm">Aguardando aprova��o</p>
          </CardContent></Card>
        </div>
      </div>
    </>
